...
ShowMessageController::ShowMessageController(std::shared_ptr<model::visualization::message::aAllMessages> allMessages) :
        ...
        model::operations::kFundType destinationFundType)
{
    ...
    else if(operationType == +model::visualization::message::kOperationType::Transfer)
    {
        ...
        literals = {literalOriginFundType, literalOperation, literalDestinationFundType, model::visualization::language::kLiterals::Value1};
...
model::visualization::language::kLiterals ShowMessageController::toLiteral(model::operations::kFundType fundType)
{
...
model::visualization::language::kLiterals ShowMessageController::toLiteral(model::visualization::message::kOperationType operationType)
{
    //TODO: Cambiar esto, es una guarreria
    std::string kLiteral = "k";
