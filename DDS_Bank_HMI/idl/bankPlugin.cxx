...
void FundTypePluginSupport_print_data(
    const FundType *sample,
    const char *description, int indent_level)
{
    ...
    RTICdrType_printEnum((RTICdrEnum *)sample, "FundType", indent_level + 1);
}
...
unsigned int 
MessageTypePlugin_get_serialized_sample_max_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
...
void MessageTypePluginSupport_print_data(
    const MessageType *sample,
    const char *description, int indent_level)
{
    if (description != NULL) {
        RTICdrType_printIndent(indent_level);
    ...
    RTICdrType_printEnum((RTICdrEnum *)sample, "MessageType", indent_level + 1);
}
...
{
    try {
        SelectFund *sample = new SelectFund();
...
{
    return SelectFundPluginSupport_create_data();
}
...
{
    SelectFundPluginSupport_destroy_data(key);
}
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SelectFund >::get().native()
        ,
        &programProperty,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            SelectFundPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            SelectFundPluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            SelectFundPluginSupport_create_key ,                (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            SelectFundPluginSupport_destroy_key);
        ...
        serializedKeyMaxSize =  SelectFundPlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        serializedKeyMaxSizeV2 = SelectFundPlugin_get_serialized_key_max_size_for_keyhash(
            epd,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = SelectFundPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                SelectFundPlugin_get_serialized_sample_max_size, epd,
...
SelectFundPlugin_copy_sample(
    ...
    const SelectFund *src)
{
    return SelectFundPluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SelectFund >::get().native()
        ;
    ...
    unsigned int length)
{
    ...
    epd.programContext.endpointPluginData = &epd;
    plugin.typeCode = (struct RTICdrTypeCode *)
    (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SelectFund >::get().native()
    ;
    pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
    SelectFund, 
    true, true, true>();
...
RTIBool SelectFundPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    SelectFund **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
SelectFundPlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    SelectFund *dst, const
    SelectFundKeyHolder *src)
{
    try {
        if (endpoint_data) {} /* To avoid warnings */   
        dst->fund_type() = src->fund_type();
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *SelectFundPlugin_new(void) 
{ 
    ...
    SelectFundPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    SelectFundPlugin_destroy_sample;
    ...
    SelectFundPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    SelectFundPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    SelectFundPlugin_get_key_kind;
    ...
    SelectFundPlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    SelectFundPlugin_return_key;
    ...
    #else
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &::rti::topic::dynamic_type< SelectFund >::get().native();
    #endif
    ...
    SelectFundPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    SelectFundPlugin_return_buffer;
    ...
    static const char * TYPE_NAME = "SelectFund";
...
void
SelectFundPlugin_delete(struct PRESTypePlugin *plugin)
{
...
{
    try {
        SelectFundAck *sample = new SelectFundAck();
        ::rti::topic::allocate_sample(*sample);
        return sample;
    } catch (...) {
        return NULL;
...
{
    return SelectFundAckPluginSupport_create_data();
}
...
{
    SelectFundAckPluginSupport_destroy_data(key);
}
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        DDS_TypeCodeFactory_get_instance(),
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SelectFundAck >::get().native()
        ,
        &programProperty,
        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            SelectFundAckPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            SelectFundAckPluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            SelectFundAckPluginSupport_create_key ,                (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            SelectFundAckPluginSupport_destroy_key);
        ...
        serializedKeyMaxSize =  SelectFundAckPlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        serializedKeyMaxSizeV2 = SelectFundAckPlugin_get_serialized_key_max_size_for_keyhash(
            epd,
            RTI_CDR_ENCAPSULATION_ID_CDR2_BE,
            0);
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = SelectFundAckPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                SelectFundAckPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                PRESTypePlugin_interpretedGetSerializedSampleSize,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
...
SelectFundAckPlugin_copy_sample(
    ...
    const SelectFundAck *src)
{
    return SelectFundAckPluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        epd.programContext.endpointPluginData = &epd;
        plugin.typeCode = (struct RTICdrTypeCode *)
        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SelectFundAck >::get().native()
        ;
        pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
        SelectFundAck, 
        true, true, true>();
    ...
    unsigned int length)
{
    ...
    epd.programContext.endpointPluginData = &epd;
    plugin.typeCode = (struct RTICdrTypeCode *)
    (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< SelectFundAck >::get().native()
    ;
    pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
    SelectFundAck, 
    true, true, true>();
...
RTIBool SelectFundAckPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    SelectFundAck **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
SelectFundAckPlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    SelectFundAck *dst, const
    SelectFundAckKeyHolder *src)
{
    try {
        if (endpoint_data) {} /* To avoid warnings */   
        dst->fund_type() = src->fund_type();
...
SelectFundAckPlugin_serialized_sample_to_keyhash(
    ...
    void *endpoint_plugin_qos)
{
    SelectFundAck * sample = NULL;
    sample = (SelectFundAck *)
    PRESTypePluginDefaultEndpointData_getTempSample(endpoint_data);
    if (sample == NULL) {
        return RTI_FALSE;
    }
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *SelectFundAckPlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    SelectFundAckPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    SelectFundAckPlugin_destroy_sample;
    ...
    plugin->getSampleFnc =
    (PRESTypePluginGetSampleFunction)
    SelectFundAckPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    SelectFundAckPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    SelectFundAckPlugin_get_key_kind;
    ...
    plugin->getKeyFnc =
    (PRESTypePluginGetKeyFunction)
    SelectFundAckPlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    SelectFundAckPlugin_return_key;
    ...
    #else
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &::rti::topic::dynamic_type< SelectFundAck >::get().native();
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    SelectFundAckPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    SelectFundAckPlugin_return_buffer;
    plugin->getBufferWithParams = NULL;
    plugin->returnBufferWithParams = NULL;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    ...
    static const char * TYPE_NAME = "SelectFundAck";
    plugin->endpointTypeName = TYPE_NAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}
...
void
SelectFundAckPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        DDS_TypeCodeFactory_get_instance(),
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Deposit >::get().native()
        ,
        &programProperty,
        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            DepositPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            DepositPluginSupport_destroy_data,
            NULL , NULL );
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = DepositPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                DepositPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                PRESTypePlugin_interpretedGetSerializedSampleSize,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
...
DepositPlugin_copy_sample(
    ...
    const Deposit *src)
{
    return DepositPluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        epd.programContext.endpointPluginData = &epd;
        plugin.typeCode = (struct RTICdrTypeCode *)
        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Deposit >::get().native()
        ;
        pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
        Deposit, 
        true, true, true>();
    ...
    unsigned int length)
{
    ...
    epd.programContext.endpointPluginData = &epd;
    plugin.typeCode = (struct RTICdrTypeCode *)
    (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Deposit >::get().native()
    ;
    pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
    Deposit, 
    true, true, true>();
...
RTIBool DepositPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    Deposit **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *DepositPlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    DepositPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    DepositPlugin_destroy_sample;
    ...
    plugin->getSampleFnc =
    (PRESTypePluginGetSampleFunction)
    DepositPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    DepositPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    DepositPlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &::rti::topic::dynamic_type< Deposit >::get().native();
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    DepositPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    DepositPlugin_return_buffer;
    plugin->getBufferWithParams = NULL;
    plugin->returnBufferWithParams = NULL;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    ...
    static const char * TYPE_NAME = "Deposit";
    plugin->endpointTypeName = TYPE_NAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}
...
void
DepositPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        DDS_TypeCodeFactory_get_instance(),
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Withdraw >::get().native()
        ,
        &programProperty,
        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    ...
    try {
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                WithdrawPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                PRESTypePlugin_interpretedGetSerializedSampleSize,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
...
WithdrawPlugin_copy_sample(
    ...
    const Withdraw *src)
{
    return WithdrawPluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        epd.programContext.endpointPluginData = &epd;
        plugin.typeCode = (struct RTICdrTypeCode *)
        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Withdraw >::get().native()
        ;
        pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
        Withdraw, 
        true, true, true>();
    ...
    unsigned int length)
{
    ...
    epd.programContext.endpointPluginData = &epd;
    plugin.typeCode = (struct RTICdrTypeCode *)
    (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Withdraw >::get().native()
    ;
    pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
    Withdraw, 
    true, true, true>();
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *WithdrawPlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    WithdrawPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    WithdrawPlugin_destroy_sample;
    ...
    */
    ...
    #else
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &::rti::topic::dynamic_type< Withdraw >::get().native();
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    WithdrawPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    WithdrawPlugin_return_buffer;
    plugin->getBufferWithParams = NULL;
    plugin->returnBufferWithParams = NULL;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    ...
    static const char * TYPE_NAME = "Withdraw";
    plugin->endpointTypeName = TYPE_NAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}
...
void
WithdrawPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
...
{
    return FundDataPluginSupport_create_data();
}
...
{
    FundDataPluginSupport_destroy_data(key);
}
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        DDS_TypeCodeFactory_get_instance(),
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FundData >::get().native()
        ,
        &programProperty,
        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            FundDataPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            FundDataPluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            FundDataPluginSupport_create_key ,                (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            FundDataPluginSupport_destroy_key);
        ...
        serializedKeyMaxSize =  FundDataPlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        serializedKeyMaxSizeV2 = FundDataPlugin_get_serialized_key_max_size_for_keyhash(
            epd,
            RTI_CDR_ENCAPSULATION_ID_CDR2_BE,
            0);
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = FundDataPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                FundDataPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                PRESTypePlugin_interpretedGetSerializedSampleSize,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
...
FundDataPlugin_copy_sample(
    ...
    const FundData *src)
{
    return FundDataPluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        epd.programContext.endpointPluginData = &epd;
        plugin.typeCode = (struct RTICdrTypeCode *)
        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FundData >::get().native()
        ;
        pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
        FundData, 
        true, true, true>();
    ...
    unsigned int length)
{
    ...
    epd.programContext.endpointPluginData = &epd;
    plugin.typeCode = (struct RTICdrTypeCode *)
    (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< FundData >::get().native()
    ;
    pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
    FundData, 
    true, true, true>();
...
RTIBool FundDataPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    FundData **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *FundDataPlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    FundDataPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    FundDataPlugin_destroy_sample;
    ...
    plugin->getSampleFnc =
    (PRESTypePluginGetSampleFunction)
    FundDataPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    FundDataPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    FundDataPlugin_get_key_kind;
    ...
    plugin->getKeyFnc =
    (PRESTypePluginGetKeyFunction)
    FundDataPlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    FundDataPlugin_return_key;
    ...
    #else
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &::rti::topic::dynamic_type< FundData >::get().native();
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    FundDataPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    FundDataPlugin_return_buffer;
    plugin->getBufferWithParams = NULL;
    plugin->returnBufferWithParams = NULL;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    ...
    static const char * TYPE_NAME = "FundData";
    plugin->endpointTypeName = TYPE_NAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}
...
void
FundDataPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        DDS_TypeCodeFactory_get_instance(),
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Message >::get().native()
        ,
        &programProperty,
        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    ...
    void *containerPluginContext)
{
    try {
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = MessagePlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        epd.programContext.endpointPluginData = &epd;
        plugin.typeCode = (struct RTICdrTypeCode *)
        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Message >::get().native()
        ;
        pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
        Message, 
        true, true, true>();
    ...
    unsigned int length)
{
    ...
    epd.programContext.endpointPluginData = &epd;
    plugin.typeCode = (struct RTICdrTypeCode *)
    (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< Message >::get().native()
    ;
    pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
    Message, 
    true, true, true>();
...
{ 
    ...
    */
    ...
    #else
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &::rti::topic::dynamic_type< Message >::get().native();
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
    ...
    static const char * TYPE_NAME = "Message";
    plugin->endpointTypeName = TYPE_NAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}
