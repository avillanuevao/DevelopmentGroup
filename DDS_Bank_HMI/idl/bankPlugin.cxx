...
Deposit *
DepositPluginSupport_create_key(void)
{
    return DepositPluginSupport_create_data();
}

void 
DepositPluginSupport_destroy_key(
    DepositKeyHolder *key) 
{
    DepositPluginSupport_destroy_data(key);
}
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            DepositPluginSupport_create_key ,                (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            DepositPluginSupport_destroy_key);
        ...
        serializedKeyMaxSize =  DepositPlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        serializedKeyMaxSizeV2 = DepositPlugin_get_serialized_key_max_size_for_keyhash(
            epd,
...
RTIBool 
DepositPlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    DepositKeyHolder *dst, 
    const Deposit *src)
{
    try {
...
RTIBool 
DepositPlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    Deposit *dst, const
    DepositKeyHolder *src)
{
    try {
        if (endpoint_data) {} /* To avoid warnings */   
        dst->fund_type() = src->fund_type();
...
RTIBool 
DepositPlugin_serialized_sample_to_keyhash(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
...
{ 
    ...
    DepositPlugin_get_key;
    plugin->returnKeyFnc =
    (PRESTypePluginReturnKeyFunction)
    DepositPlugin_return_key;
