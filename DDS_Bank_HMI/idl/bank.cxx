...
Deposit::Deposit(Deposit&& other_) OMG_NOEXCEPT  :m_fund_type_ (std::move(other_.m_fund_type_))
,
    ...
    namespace topic {
        ...
        struct native_type_code< Deposit > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member Deposit_g_tc_members[2]=
                {
                ...
                Deposit_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< FundType>::get().native();
                Deposit_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_short;

                /* Initialize the values for member annotations. */
                Deposit_g_tc_members[0]._annotations._defaultValue._d = RTI_XCDR_TK_ENUM;
                Deposit_g_tc_members[0]._annotations._defaultValue._u.enumerated_value = 0;

                Deposit_g_tc_members[1]._annotations._defaultValue._d = RTI_XCDR_TK_SHORT;
                Deposit_g_tc_members[1]._annotations._defaultValue._u.short_value = 0;
                Deposit_g_tc_members[1]._annotations._minValue._d = RTI_XCDR_TK_SHORT;
                Deposit_g_tc_members[1]._annotations._minValue._u.short_value = RTIXCdrShort_MIN;
                Deposit_g_tc_members[1]._annotations._maxValue._d = RTI_XCDR_TK_SHORT;
                Deposit_g_tc_members[1]._annotations._maxValue._u.short_value = RTIXCdrShort_MAX;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo Deposit_g_memberAccessInfos[2] =
                {RTIXCdrMemberAccessInfo_INITIALIZER};
                ...
                Deposit_g_memberAccessInfos[1].bindingMemberValueOffset[0] = 
