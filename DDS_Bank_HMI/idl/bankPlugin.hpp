...
#ifndef bankPlugin_1860238290_h
#define bankPlugin_1860238290_h
...
NDDSUSERDllExport extern unsigned int 
MessageTypePlugin_get_serialized_key_max_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment);
...
NDDSUSERDllExport extern unsigned int 
MessageTypePlugin_get_serialized_key_max_size_for_keyhash(
    PRESTypePluginEndpointData endpoint_data,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment);
...
NDDSUSERDllExport extern void
MessageTypePluginSupport_print_data(
    const MessageType *sample, const char *desc, int indent_level);
