#include "MessageDDStoAbstractAdapter.hpp"
...
MessageDDStoAbstractAdapter::MessageDDStoAbstractAdapter(Message message) :
  model::visualization::message::aMessage(createMessage(message))
{

}

std::vector<model::visualization::language::kLiterals> MessageDDStoAbstractAdapter::toLiterals(
    std::vector<int> iLiterals)
{
...
model::visualization::message::aMessage MessageDDStoAbstractAdapter::createMessage(Message message)
{
  ...
  model::visualization::message::kMessageType modelMessageType =
      model::visualization::message::kMessageType::_from_index(ddsMessageType);
